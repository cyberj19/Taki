function Dialog() {
    ...
    this.close = function() {
        ...
        //_this.dialogContainer.getElementsByClassName('approve')[0].removeEventListener('click');
        //_this.dialogContainer.getElementsByClassName('cancel')[0].removeEventListener('click');
    };
    this.open = function(title, description, approveFunction) {
        ...
        _this.dialogContainer.getElementsByClassName('approve')[0].addEventListener('click', approveFunction);
